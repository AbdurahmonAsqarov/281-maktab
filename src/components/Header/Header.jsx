  ...
  return (
    <>
     ...
     <div className='bg-img bg-fixed h-[130vh] '>
         ...
         <h1 className='z-10 text-[80px] max-md:text-[40px] text-[#EBE3D5] font-[800] backdrop-blur-sm'><span onClick={whiteToggle} className='Dowhite text-[#776B5D]'>281-sonli</span>umumiy o'rta   </h1>
