  ...
  return (
    <>
     ...
     <div className='bg-img bg-fixed h-[130vh] '>
         ...
         <h1 className='z-10 text-[80px] max-md:text-[40px] text-[#EBE3D5] font-[800] backdrop-blur-sm'><span onClick={whiteToggle} className='Dowhite text-[#776B5D]'>281-sonli</span> o'rta umumiy  </h1>
         <h1 className='text-[#EBE3D5] text-[80px] font-[800] max-md:text-[40px] backdrop-blur-sm '>ta'lim maktabi</h1>

         <div className="grid grid-cols-2 gap-y-[5px] mt-[50px]  gap-x-10 max-md:gap-3">
           <div className=' place-content-end flex'>
           <button  className='ad text-[#EBE3D5] flex font-[600] bg-[#776B5D] px-[25px] max-md:w-[170px] max-sm:w-[150px] w-[200px] py-[20px] max-sm:px-[15px] rounded-bl-3xl rounded-tr-3xl justify-between border border-[#EBE3D5]  hover:border-[3px]  ease-in duration-300'>
          ...
          <button onClick={TelClick} className=' max-sm:w-[150px] text-[#776B5D] hover:text-[#EBE3D5] flex bg-[#EBE3D5] hover:bg-[#776B5D] font-[600] px-[25px] max-sm:px-[15px] hover:px-[20px]  max-md:w-[190px] w-[200px] py-[20px] rounded-bl-3xl rounded-tr-3xl justify-between border-[3px] border-[#B0A695] hover:border-[#EBE3D5]  hover:w-[180px]  ease-in duration-300 hover:origin-top-left hover:rotate-12'>
          ...
          <IoIosArrowDown  className='text-[24px] max-md:text-[20px]  max-lg:block  cursor-pointer' />
               ...
               <h1 className='max-md:border-none max-md:text-[10px] border-[3px] border-[#776B5D] px-[10px] py-[10px] rounded-br-3xl rounded-tl-3xl hover:animate-pulse'>Toshkent shahar Chilonzor tumani</h1>
