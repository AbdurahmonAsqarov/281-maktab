...
const Footer = () => {
  return (
    <>
        ...
        <div className='mb-[50px] flex place-content-center img-dec'>
            <img src="../src/school_decoration" alt="" className='bruh3 w-[70vw] h-[80vh] rounded-[30px] max-md:h-[40vh] max-lg:h-[60vh]'/>
        </div> 
